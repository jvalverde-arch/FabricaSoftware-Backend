...
- **Puerto propio**: `ILlmProvider` (Application) con dos adaptadores en Infrastructure — **Anthropic** sobre el SDK oficial (`Anthropic` 12.48.0) y **OpenAI-compatible** sobre `HttpClient` plano, que cubre Azure OpenAI, vLLM y Ollama. Ningún agente ni servicio conoce al proveedor.
