...
- **Contraseñas**: Argon2id (sección `Argon2`), mínimo 12 caracteres (`Auth:MinimumPasswordLength`), lista embebida de contraseñas comunes (SecLists, MIT), sin reglas de complejidad. Lockout progresivo: cada 5 fallos bloquea 1 minuto, duplicando en cada bloque, con tope de 1 día. Si los parámetros de Argon2 cambian, el hash se regenera en el siguiente inicio de sesión sin invalidar sesiones.
